function bubbleSort(arr) {
    let noSwaps;                                          // Since the i equals to the length of the array, the outer loop will run until i is greater than 0.
    for (let i = arr.length; i > 0; i--) {
        noSwaps = true;                                  // ==> Because inner loop's process is dependent on outer loop, this is why we start i from end toward the start.
