...
function quickSort(arr, left = 0, right = arr.length - 1) {
    if (left < right) { // (left denotes index and right denotes length of indices) base case - no more elements to sort in the sub-array at this point in the recursion, there will be a point when when left will be equal to right in the base case, and there will be no more sub-arrays to sort.
